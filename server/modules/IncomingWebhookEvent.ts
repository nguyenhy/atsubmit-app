...
/**
 * record.provider = 'aws_sns' AND payload.Type = 'ses_reject'
 */
export const AWS_SNS_WEBHOOK_EVENT_TYPE_SES_REJECT = "ses_reject";
/**
...
export interface IncomingWebhookEvent {
     ...
     * - "manual_pending": waiting to be manual processed
